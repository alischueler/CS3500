...
public class BasicShape implements Shape {
  ...
  public String toString() {
    try {
      return this.name + " " + this.shapeType + " " + this.currPos.toString() + " " +
          this.currDimensions.toString() + " " + this.currColor.toString() + " " + startTick + " "
          + endTick + " " + startPos + " " + endPos + " " + startColor + " " +
          endColor + " " + startDimensions + " " + endDimensions;
    }
