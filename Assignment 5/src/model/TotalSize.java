...
public class TotalSize {
   ...
   */
  public TotalSize(double h, double w) {
    checkHW(h, w);
    this.totalHeight = h;
    this.totalWidth = w;
  }
  ...
  public TotalSize(List<String> posList) {
    ...
    this.setTotalHeight(Integer.parseInt(posList.get(0)));
    this.setTotalWidth(Integer.parseInt(posList.get(1)));
  }
   ...
   */
  public void updateDimensions(double h, double w) {
    checkHW(h, w);
   ...
   */
  protected void checkHW(double h, double w) throws IllegalArgumentException {
    if (h < 0 || w < 0) {
