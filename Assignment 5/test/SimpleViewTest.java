...
public class SimpleViewTest {
  ...
  protected void examples() {
    ...
    simpView = new SimpleAnimatorView(simpModel);
    ...
    multView = new SimpleAnimatorView(multipleShapeModel);

    //notstarted
    notStartedView = new SimpleAnimatorView(notStartedModel);

    //empty
    emptyModel.startAnimator(noCommands);
    noCommandsView = new SimpleAnimatorView(emptyModel);

    //assignment example
    assignmentCommands.put("R", drawR);
    assignmentCommands.put("C", drawC);
    assignmentModel.startAnimator(assignmentCommands);
    classView = new SimpleAnimatorView(assignmentModel);
