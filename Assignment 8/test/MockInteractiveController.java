...
/**
 * A Mock InteractiveController to be able to test it and the listener methods within it.
 */
public class MockInteractiveController extends InteractiveController {

  private Appendable log;

  /**
   * Contructs a mock interactive controller.
   *
   ...
   */
  protected MockInteractiveController(IAnimator<Shape> model, IAnimatorView view,
