...
/**
 * an mock implementation of discrete controller to be able to test the effect of the listeners.
 */
public class MockDiscreteController extends DiscreteController {
   ...
   */
  public MockDiscreteController(IAnimator<Shape> model, IAnimatorView view,
    ...
    buttonMap.put("discrete", new MockDiscreteAnimation());
    ...
    buttonMap.put("discrete info", new MockDiscreteInfo());
    buttonList.setButtonClickedActionMap(buttonMap);
  }

  /**
   * changes the view to discrete or normal.
   */
  public class MockDiscreteAnimation extends ToggleDiscrete {

    @Override
    public void run() {
      super.run();
      appendString("animation changed to discrete at tick " + currTick);
    }
  }
   ...
   */
  public class MockDiscreteInfo extends DiscreteInfo {

    @Override
    public void run() {
      super.run();
      appendString("discrete info button pressed");
    }
  }
