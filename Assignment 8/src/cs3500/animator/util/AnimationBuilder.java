...
/**
 * interface to build a animation.
 *
 * @param <Doc> the builder that's being made
 */
public interface AnimationBuilder<Doc> {
  ...
  /**
   * adds a tempo command to a animation
   *
   * @param t1    start tick
   * @param t2    end tick
   * @param tempo end tempo
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<IAnimator<Shape>> addTempo(int t1, int t2, int tempo);
}
