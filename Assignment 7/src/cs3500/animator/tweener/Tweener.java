...
public class Tweener implements ITweener<Shape> {
  ...
  private void changeSize(int tick, Shape shape) {
    ...
    TotalSize startPos = shape.getCurrCommand().getStartSize();
    TotalSize endPos = shape.getCurrCommand().getEndSize();
  ...
  private void changeColor(int tick, Shape shape) {
    ...
    int amountOfTime = shape.getCurrCommand().getTicks().getEnd() -
        shape.getCurrCommand().getTicks().getStart();
    Color startPos = shape.getCurrCommand().getStartColor();
    Color endPos = shape.getCurrCommand().getEndColor();
  ...
  private void changePosition(int tick, Shape shape) {
    ...
    int amountOfTime = shape.getCurrCommand().getTicks().getEnd() -
        shape.getCurrCommand().getTicks().getStart();
    Position startPos = shape.getCurrCommand().getStartPosition();
    Position endPos = shape.getCurrCommand().getEndPosition();
