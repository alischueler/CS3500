...
public class CardTest {
  ...
  //finds the exposed value of a a card in the bottom of the pyramid
  @Test
  public void testFindExposedBottom() {
    Card c = new Card(12, 4);
    assertEquals(false, c.isExposed());
    c.assignPyramidCard(2, 2, 3);
    assertEquals(true, c.isExposed());
  }

  //change the exposed value of the card to true
  @Test
  public void testChangeExposed() {
    Card c = new Card(8, 1);
    assertEquals(false, c.isExposed());
    c.assignPyramidCard(5, 2, 6);
    assertEquals(true, c.isExposed());
  }

  //finds the exposed value of a a card in the inner of the pyramid
  @Test
  public void testFindExposedInner() {
    Card c = new Card(12, 4);
    assertEquals(false, c.isExposed());
    c.assignPyramidCard(0, 0, 6);
    assertEquals(false, c.isExposed());
  }

  //determines the row of a card in the pyramid
  @Test
  public void testRowPyramid() {
    Card c = new Card(12, 4);
    c.assignPyramidCard(3, 2, 7);
    assertEquals(3, c.getRow());
  }

  //determines the card of a card in the pyramid
  @Test
  public void testCardPyramid() {
    Card c = new Card(4, 2);
    c.assignPyramidCard(6, 4, 7);
    assertEquals(4, c.getCard());
  }

  //tests this card does have the given coordinates
  @Test
  public void testCoordinatesTrue() {
    Card c = new Card(1, 4);
    c.assignPyramidCard(8, 7, 9);
    assertEquals(true, c.checkCoordinates(8, 7));
  }

  //tests this card does not have the given coordinates (one wrong)
  @Test
  public void testCoordinatesOneFalse() {
    Card c = new Card(5, 3);
    c.assignPyramidCard(7, 5, 8);
    assertEquals(false, c.checkCoordinates(7, 6));
  }

  //tests this card does not have the given coordinates (both wrong)
  @Test
  public void testCoordinatesBothFalse() {
    Card c = new Card(11, 2);
    c.assignPyramidCard(6, 4, 7);
    assertEquals(false, c.checkCoordinates(5,4));
  }
