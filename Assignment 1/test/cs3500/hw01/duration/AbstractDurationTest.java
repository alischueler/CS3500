...
public abstract class AbstractDurationTest {
  ...
  //tests for hms constructr throwing exceptions
  @Test(expected = IllegalArgumentException.class)
  public void hmsConstructorDisallowsNegative() {
    hms(2, 4, -9);
  }

  //tests for seconds constructor throwing excpetions
  @Test(expected = IllegalArgumentException.class)
  public void secondsConstructorDisallowsNegative() {
    sec(-1);
  }

  //tests comparing inSeconds and seconds constructor
  @Test
  ...
  //tests for hms and plus combined
  @Test
