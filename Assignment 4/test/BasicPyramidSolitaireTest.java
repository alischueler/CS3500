...
public class BasicPyramidSolitaireTest {
  ...
  public void TooLargeRow() {
    PyramidSolitaireModel<Card> basic = new BasicPyramidSolitaire();
  ...
  public void NegDraw() {
    PyramidSolitaireModel<Card> basic = new BasicPyramidSolitaire();
    basic.startGame(basic.getDeck(), false, 2, -5);
  }
  ...
  public void invalidDeck() {
    ...
    invalidCards.add(new Card());
    basic.startGame(invalidCards, false, 3, 4);
  }
  ...
  public void SmallDeck() {
    ...
    basic.startGame(smallDeck, false, 8, 2);
  }
  ...
  public void testDeckShuffleTrue() {
    PyramidSolitaireModel<Card> shuffleTrue =
        new BasicPyramidSolitaire();
    PyramidSolitaireModel<Card> shuffleFalse = new BasicPyramidSolitaire();
  ...
  public void testDeckShuffleFalse() {
    PyramidSolitaireModel<Card> shuffleFalse =
        new BasicPyramidSolitaire();
    PyramidSolitaireModel<Card> shuffleFalse2 = new BasicPyramidSolitaire();
  ...
  public void sameNumDraw() {
    PyramidSolitaireModel<Card> numDraw1 =
        new BasicPyramidSolitaire();
    PyramidSolitaireModel<Card> numDraw2 = new BasicPyramidSolitaire();
  ...
  public void RemoveOneWithDraw() {
    PyramidSolitaireModel<Card> example1 =
        new BasicPyramidSolitaire();
  ...
  public void RemoveOneWithDrawNot13() {
    PyramidSolitaireModel<Card> example =
        new BasicPyramidSolitaire();
