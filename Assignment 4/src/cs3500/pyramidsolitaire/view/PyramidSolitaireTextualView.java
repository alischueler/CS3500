      ...
      for (int i = 0; i < this.model.getNumRows(); i++) { //row
        for (int j = 0; j < this.model.getRowWidth(i); j++) { //card
          ...
          if (i == 0) { //first row
            ...
            if (this.model.getRowWidth(i) - 1 == 0) { //if there is only one card in first row
              result = result + totalSpaces + board[i][j] + "\n";
            } else { //more than one card in first row
              if (j == 0) { //first card
          ...
          else if (i == this.model.getNumRows() - 1) { //last row
          ...
          else if (i != this.model.getNumRows() - 1 && i != 0) { //middle rows
            if (j == 0) { //first card
              for (int m = 1; m <= spacingThisRow; m++) {
                totalSpaces += " ";
              }
